...
export interface Project {
  ...
  image: string;
  featured: boolean;
  status: string; // "Concluído" | "Em andamento" | etc.
}

/** Props para o componente FeaturedProjects */
interface FeaturedProjectsProps {
  /** Lista de projetos (opcional); se não vier, usa [] */
  projects?: Project[];
}
    ...
    <section id="projetos" className="py-20 px-4 bg-muted/30">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mb-4" />
